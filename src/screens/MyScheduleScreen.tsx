...
const styles = StyleSheet.create({
  ...
  dayRowToday: { borderColor: colors.nova25 },
  dayRowOff: { backgroundColor: colors.white03 },
  dayShort: {
    fontSize: 14,
    fontWeight: "600",
  ...
  pillSelected: { backgroundColor: colors.warmWhite15 },
  ...
  overrideRowBlocked: {
    backgroundColor: colors.error04,
    borderWidth: 1,
    borderColor: colors.error15,
  },
  overrideRowCustom: {
    backgroundColor: colors.steelAlt04,
    borderWidth: 1,
    borderColor: colors.steelAlt15,
  },
  overrideIcon: {
    width: 32,
    height: 32,
  ...
  overrideIconBlocked: { backgroundColor: colors.error10 },
  overrideIconCustom: { backgroundColor: colors.steelAlt10 },
  overrideInfo: { flex: 1 },
  ...
  typeOptionActiveBlue: {
    ...
    backgroundColor: colors.steelAlt06,
  },
